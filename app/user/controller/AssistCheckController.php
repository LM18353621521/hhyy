 ...
 */
class AssistCheckController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $keywordComplex = [];
        $usersQuery = Db::name('user_assist_check');
    ...
    public function addPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if(empty($data['id'])){
                ...
                adminLog("添加辅助检查(ID:$res)");
                $this->success('添加成功!', url('AssistCheck/index', ['user_id' => $data['user_id']]));
            }else{
    ...
    public function delete()
    {
        ...
        if (isset($param['id'])) {
            ...
            adminLog("删除辅助检查(ID:".$id.")");
            $this->success("删除成功！", '');
        }
        if (isset($param['ids'])) {
            $ids     = $this->request->param('ids/a');
            $result  = $model->where(['id' => ['in', $ids]])->delete();
            adminLog("删除辅助检查(ID:".implode(",",$ids).")");
            if ($result) {
                $this->success("删除成功！", '');
            }
        }
